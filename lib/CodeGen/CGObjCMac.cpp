...
//
//===----------------------------------------------------------------------===//
#include <dlfcn.h> // added for objective-c JIT support
...
// Preliminary work for JIT/interpreter support.
// This should really be in a its own source file, since it's intended to
// be platform/runtime-independent. However, it uses the "common" 
// ObjCTypesHelper class, which is internal to this file.
//
class CGObjCJit : public CGObjCRuntime {
  ...
  private: // data
    ...
    llvm::Constant *function_objc_getClass;
    llvm::Constant *function_objc_getMetaClass;
    llvm::Constant *function_objc_getProtocol;
    llvm::Constant *function_class_addMethod;
    llvm::Constant *function_class_replaceMethod;
    llvm::Constant *function_class_getMethodImplementation;
    llvm::Constant *function_object_getClass;

    // GNU runtime workaround
    llvm::Constant *function_objc_msg_lookup;
  ...
  protected: // methods
    ...
    // Native ObjC runtine APIs, referenced dynamically
...
CGObjCJit::CGObjCJit(CodeGen::CodeGenModule &cgm)
    : CGObjCRuntime(cgm),
      ...
      ObjCTypes(cgm),
      JitInitFunction(0),
      function_objc_getClass(0),
      function_objc_getMetaClass(0),
      function_objc_getProtocol(0),
      function_class_addMethod(0),
      function_class_replaceMethod(0),
      function_class_getMethodImplementation(0),
      function_object_getClass(0),
      function_objc_msg_lookup(0) {
      
  puts("Constructing CGObjCJit");

  // TODO: For now, just searching for pre-loaded objc runtime
  *(void**)(&_objc_getClass) = dlsym(RTLD_DEFAULT, "objc_getClass");

  // Don't bother to try the rest if the first one wasn't available
  if (_objc_getClass) {
    isUsable = true;
    *(void**)(&_objc_allocateClassPair) = dlsym(RTLD_DEFAULT, "objc_allocateClassPair");
    *(void**)(&_objc_registerClassPair) = dlsym(RTLD_DEFAULT, "objc_registerClassPair");
    *(void**)(&_objc_getProtocol)       = dlsym(RTLD_DEFAULT, "objc_getProtocol");
    *(void**)(&_object_getClass)        = dlsym(RTLD_DEFAULT, "object_getClass");
    *(void**)(&_sel_registerName)       = dlsym(RTLD_DEFAULT, "sel_registerName");
    *(void**)(&_class_getClassVariable) = dlsym(RTLD_DEFAULT, "class_getClassVariable");
    *(void**)(&_class_addIvar)          = dlsym(RTLD_DEFAULT, "class_addIvar");
    *(void**)(&_class_addProtocol)      = dlsym(RTLD_DEFAULT, "class_addProtocol");
    *(void**)(&_class_getMethodImplementation)
                                        = dlsym(RTLD_DEFAULT, "class_getMethodImplementation");
    *(void**)(&_ivar_getOffset)         = dlsym(RTLD_DEFAULT, "ivar_getOffset");
    *(void**)(&_NSGetSizeAndAlignment)  = dlsym(RTLD_DEFAULT, "NSGetSizeAndAlignment");

    puts("Creating JitInitFunction");
    llvm::FunctionType *initFuncType = 
        llvm::FunctionType::get(llvm::Type::getVoidTy(VMContext), false);

    JitInitFunction = cast<llvm::Function>(
        CGM.getModule().getOrInsertFunction(llvm::StringRef(".objc_jit_init"), 
                                            initFuncType));        
    ...
    llvm::Type *getClassOrProtocolParams[] = { ObjCTypes.Int8PtrTy };
    
    llvm::FunctionType *getClassFuncType = 
        llvm::FunctionType::get(ObjCTypes.ClassPtrTy, getClassOrProtocolParams, false);
    function_objc_getClass = 
        CGM.CreateRuntimeFunction(getClassFuncType, "objc_getClass");
    function_objc_getMetaClass = 
        CGM.CreateRuntimeFunction(getClassFuncType, "objc_getMetaClass");

    llvm::FunctionType *getProtocolFuncType = 
        llvm::FunctionType::get(ObjCTypes.ProtocolPtrTy, getClassOrProtocolParams, false);
    function_objc_getProtocol = 
        CGM.CreateRuntimeFunction(getProtocolFuncType, "objc_getProtocol");

    llvm::FunctionType *getObjectClassFuncType = 
        llvm::FunctionType::get(ObjCTypes.ClassPtrTy, getClassOrProtocolParams, false);
    function_object_getClass = 
        CGM.CreateRuntimeFunction(getObjectClassFuncType, "object_getClass");
    ...
    llvm::FunctionType *addReplaceFuncType = 
        llvm::FunctionType::get(llvm::Type::getInt8Ty(VMContext),
                                                      Params, false);
    function_class_addMethod = 
        CGM.CreateRuntimeFunction(addReplaceFuncType, "class_addMethod");

    function_class_replaceMethod = 
        CGM.CreateRuntimeFunction(addReplaceFuncType, "class_replaceMethod");

    llvm::Type *ImpParams[] = { ObjCTypes.ObjectPtrTy, ObjCTypes.SelectorPtrTy };
    llvm::Type *ImpTy = llvm::PointerType::getUnqual(
      llvm::FunctionType::get(ObjCTypes.ObjectPtrTy, ImpParams, true));
    llvm::Type *ImpPtrTy = llvm::PointerType::getUnqual(ImpTy);

    llvm::Type *getMethodImpParams[] = { ObjCTypes.ClassPtrTy, 
                                         ObjCTypes.SelectorPtrTy };

    function_class_getMethodImplementation = 
        CGM.CreateRuntimeFunction(llvm::FunctionType::get(ImpPtrTy,
                                                          getMethodImpParams, false),
                                  "class_getMethodImplementation");

    // Unfortunately, even though class_getMethodImplementation is provided by the GNU
    // runtime, it doesn't work on a class unless objc_msg_lookup was called first.
    *(void**)(&_objc_msg_lookup) = dlsym(RTLD_DEFAULT, "objc_msg_lookup");
    if (_objc_msg_lookup ) {
      function_objc_msg_lookup = 
          CGM.CreateRuntimeFunction(llvm::FunctionType::get(ImpPtrTy,
                                                            getMethodImpParams, false),
                                    "objc_msg_lookup");
    } else {
...
llvm::Value *CGObjCJit::GetSelector(CGBuilderTy &Builder, 
                                    Selector Sel, bool /*lval*/) {
  if (isUsable) {
...
llvm::Value *CGObjCJit::GetSelector(CGBuilderTy &Builder,
                                    const ObjCMethodDecl *Method) {
  return GetSelector(Builder, Method->getSelector());
}
...
void CGObjCJit::GenerateClass(const ObjCImplementationDecl *ClassDecl) {
  if (isUsable) {
    ...
    if (superClassDecl) {
      const char* superClassName = superClassDecl->getIdentifier()->getNameStart();
...
CGObjCJit::GenerateMessageSend(CodeGen::CodeGenFunction &CGF,
  ...
  if (Class)
    ...
    ReceiverClass = CGF.Builder.CreateCall(function_object_getClass, Receiver);
...
CGObjCJit::GenerateMessageSendSuper(CodeGen::CodeGenFunction &CGF,
  ...
  if (IsClassMessage)
    if (isCategoryImpl)
      ReceiverClass = GetClass(CGF.Builder, Class);
    else
      ReceiverClass = GetMetaClass(CGF.Builder, Class);
  else
    ReceiverClass = GetClass(CGF.Builder, Class->getSuperClass());
...
llvm::Value *CGObjCJit::GenerateProtocolRef(CGBuilderTy &Builder,
                                         const ObjCProtocolDecl *PD) {
  if (isUsable) {
    ...
    if (it != DefinedProtocols.end()) {
      ...
      ProtocolName = Builder.CreateStructGEP(ProtocolName, 0);
      return Builder.CreateCall(function_objc_getProtocol, ProtocolName);
    }
  }
  return 0;
}
...
llvm::Value *CGObjCJit::GetClass(CGBuilderTy &Builder,
                                 const ObjCInterfaceDecl *ID) {
  if (isUsable) {
    llvm::Value *ClassName = 
        CGM.GetAddrOfConstantCString(ID->getNameAsString());
    ClassName = Builder.CreateStructGEP(ClassName, 0);
    return Builder.CreateCall(function_objc_getClass, ClassName);
  }
  return 0;
}
...
llvm::Value *CGObjCJit::GetMetaClass(CGBuilderTy &Builder,
  ...
  if (isUsable) {
    llvm::Value *ClassName = 
        CGM.GetAddrOfConstantCString(ID->getNameAsString());
    ClassName = Builder.CreateStructGEP(ClassName, 0);
    return Builder.CreateCall(function_objc_getMetaClass, ClassName);
  }
  return 0;
}
...
CGObjCJit::EmitMessageSend(CodeGen::CodeGenFunction &CGF,
  ...
  llvm::Value *Arg1 = GetSelector( CGF.Builder, Sel);
  ...
  // Unfortunately, using the GNU runtime version of class_getMethodImplementation
  // and then calling the resulting IMP doesn't work unless objc_msg_lookup was 
  // already called first. TODO: avoid doing this every time
  //
  if (function_objc_msg_lookup) {
    getImp = CGF.Builder.CreateCall2(function_objc_msg_lookup, 
                                     Arg0, 
                                     Arg1);
  } else { // use the universal way
    getImp = CGF.Builder.CreateCall2(function_class_getMethodImplementation, 
                                     Arg0Class, 
                                     Arg1);
  }
  ...
  llvm::Type *ImpTy = llvm::PointerType::getUnqual(
      llvm::FunctionType::get(ReturnTy, 
                              ImpParams, 
...
void CGObjCJit::AddMethodsToClass(void *theClass) {
  ...
  while (I != MethodDefinitions.end()) {
    ...
    llvm::Value *SelectorArg = GetSelector(Builder, D->getSelector());
    llvm::Value *TypeArg =
    ...
    Builder.CreateCall4(function_class_addMethod, 
                        ClassArg, 
                        SelectorArg, 
                        I->second, 
                        TypeArg);
  ...
  if (isUsable) {
    ...
    if (stringClass) {
      ...
      if (_objc_msg_lookup) {
        ...
        stringAlloc_imp = _class_getMethodImplementation(stringMetaClass, allocSel);
      }
...
llvm::GlobalVariable *CGObjCJit::GetClassGlobal(const std::string &Name) {
  llvm_unreachable("CGObjCMac::GetClassGlobal");
  return 0;
}
